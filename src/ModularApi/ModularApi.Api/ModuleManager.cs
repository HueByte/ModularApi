...
using ModularBase.Abstraction;
using Serilog;

namespace ModularApi.Api
{
...
//     var loader = new ModularApi.Module.ModuleLoader(services);
// #if DEBUG
//     loader.BuildDevModules();
// #endif
// loader.LoadModules();
// loader.RegisterModuleServices();
